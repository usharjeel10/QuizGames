...
public class Pin : MonoBehaviour {
	...
	public bool PressedButtonofSpace;
	private AudioSource audioSource;
	private Animator animator;
	private bool isSticked = false;
	private bool isFire = false;
	private bool hasTouched = false;
	public bool ispressedPin;
	void Awake(){
	...
	public void IspresedPin () { ispressedPin = true; Debug.Log("123"); }
	
	public void KeyBoardButton(){
		if(Input.GetKeyDown(KeyCode.Space)|| ispressedPin||Input.GetMouseButtonDown(0)){
			ispressedPin = false;
